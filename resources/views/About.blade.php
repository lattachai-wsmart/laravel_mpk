...
<img src="{{asset('img/about/bartop.png')}}" width="100%" alt=""/>
    ...
    <div class="col-12" style="min-height:500px;">
            ...
            <div class="col-md-6 text_contant">
                        เราคือศุนย์นำเข้าและจำหน่ายอุปกรณืแต่งรถมอเตอร์ไซต์ SUPERBIKE<br>
                    อย่างเป็นทางการ ทั้งปลีกและส่งจากหลากหลาย แบรนด์ชั้นนำทั่วโลก<br>
                    สำหรับรถ DUCATI, BMW, TRIUMPH, HONDA, KAWASAKI, SUZUKI และอื่นๆ<br>
                    รวมถึงการให้บริการ ดูแลรถแบบ ONE STOP SERVICE
             </div>
            <div class="col-md-3"></div>
            </div>
    </div>
